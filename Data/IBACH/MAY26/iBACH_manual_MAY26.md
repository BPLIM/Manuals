...
subtitle: Extraction Date - May 2026
author: BPLIM
date: 15 May 2026
...
doi: 10.17900/iBACH.May2026.V1 | 10.48719/BELab.iBACH0824_01
pdf-engine: pdflatex
execute:
  echo: false
format:
...
> **Version of the data**: The data made available by BPLIM and BELab corresponds to a data freeze at a certain time of the year. Therefore, all files contain the information as reported in the extraction date. The most recent update of the data occurred in May 2026.
...
> **Digital Object Identifier**: 10.17900/iBACH.May2026.V1 | 10.48719/BELab.iBACH0824_01
...
> **New in this extraction**: Data for 2023 was updated and data for 2024 is now available for Portugal and Spain.
...
Every year BPLIM and BELab create a data freeze. The most recent version of the data was extracted on May 2026 and includes data from 2008 to 2024.
...
| **iBACH - Spain** | BELab_iBACH*eeee*\_01_*yyyy*_ES_Anonimized.csv  |
...
[META_IBACH_A_YFRM_20082024_MAY26_PTES_V01](./aux_files/metadata/META_IBACH_A_YFRM_20082024_MAY26_PTES_V01.xlsx).
...
`Localization of the firm` (*dregio*) - Localization of the firm (or the headquarter of the firm), at NUTS-3 level. For a complete list of codes see the metadata file [META_IBACH_A_YFRM_20082024_MAY26_PTES_V01](./aux_files/metadata/META_IBACH_A_YFRM_20082024_MAY26_PTES_V01.xlsx). Codes started by "1" are specific to Spain and by "2" to Portugal.
...
`Sector of activity` (*dsector*) - Main economic activity of the firm, according to the NACE Rev. 2 classification at 4-digit level.[^5] For a complete list of codes see the metadata file [META_IBACH_A_YFRM_20082024_MAY26_PTES_V01](./aux_files/metadata/META_IBACH_A_YFRM_20082024_MAY26_PTES_V01.xlsx).
...
*| output: false
*| echo: false
*| execution: {iopub.execute_input: '2026-05-18T22:54:04.821780Z', iopub.status.busy: '2026-05-18T22:54:04.821272Z', iopub.status.idle: '2026-05-18T22:54:04.952942Z', shell.execute_reply: '2026-05-18T22:54:04.951720Z', shell.execute_reply.started: '2026-05-18T22:54:04.821749Z'}
*| scrolled: true
local extraction="MAY26"
local ref="2026_05"
local startyr="2008"
local finyear="2024"
local version="V01"
...
Table 1- Number of firms over the data period - Portugal (as of May 2026 extraction)

```{stata}
*| output: true
*| echo: false
*| ExecuteTime: {end_time: '2023-06-19T16:42:24.254523Z', start_time: '2023-06-19T16:41:31.483892Z'}
*| execution: {iopub.execute_input: '2026-05-18T22:54:07.129252Z', iopub.status.busy: '2026-05-18T22:54:07.128889Z', iopub.status.idle: '2026-05-18T22:58:12.260551Z', shell.execute_reply: '2026-05-18T22:58:12.259338Z', shell.execute_reply.started: '2026-05-18T22:54:07.129225Z'}
...
Table 2- Number of firms over the data period - Spain (as of May 2026 extraction)

```{stata}
*| output: true
*| echo: false
*| execution: {iopub.execute_input: '2026-05-18T22:58:34.557416Z', iopub.status.busy: '2026-05-18T22:58:34.557073Z', iopub.status.idle: '2026-05-18T23:03:35.627956Z', shell.execute_reply: '2026-05-18T23:03:35.626732Z', shell.execute_reply.started: '2026-05-18T22:58:34.557390Z'}
forval yy=`startyr'/`finyear' {
    if (`yy'<2022) {
        local per "0822"
}
...
| :--- | :---: |
| Portugal | [stat_Portugal](./aux_files/descriptive_statistics/Portugal/METATSS_BPLIM_IBACH_A_YFRM_20082024_MAY26_PT_V01.xlsx) |
| Spain | [stat_Spain](./aux_files/descriptive_statistics/Spain/METATSS_BPLIM_IBACH_A_YFRM_20082024_MAY26_ES_V01.xlsx) |
...
For example, using the file with Portuguese data for 2024:

```{stata}
*| eval: false
*| echo: true
*| code-fold: false
import delimited using "./BPLIM_IBACH_A_YFRM_2024_MAY26_PT_V01.csv", ///
clear varnames(1) delimiter(";")
metaxl clear, force
metaxl apply, meta(./metadata/META_IBACH_A_YFRM_20082024_MAY26_PTES_V01)
describe
```
...
Banco de Portugal Microdata Research Laboratory (BPLIM) (2026): Portuguese Companies Microdata (iBACH). Extraction: May 2026. Version: V1. Banco de Portugal - BPLIM. Dataset. https://doi.org/10.17900/iBACH.May2026.V1

BELab. Banco de España/CORPME, Colegio de Registradores de la Propiedad y Mercantiles de España. Spanish Companies Microdata (iBACH). DOI: 10.48719/BELab.iBACH0824_01
