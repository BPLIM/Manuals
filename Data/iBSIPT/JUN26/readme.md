...
In this folder we make available the [data manual](https://github.com/BPLIM/Manuals/blob/master/Data/iBSIPT/JUN26/iBSIPT_manual_JUN26.pdf) and auxiliary documentation ([metadata files](https://github.com/BPLIM/Manuals/blob/master/Data/iBSIPT/JUN26/aux_files/metadata) of the most recent extraction of Individual MFI Balance Sheet Items Portugal (June 2026).
...
To cite this data set you can use the package biblatex with the following [BibTeX entry](https://github.com/BPLIM/Manuals/blob/master/Data/iBSIPT/JUN26/aux_files/bibtex/iBSIPT.bib):
