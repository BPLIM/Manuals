...
In all files each row corresponds to one firm in a given year.[^2] All files are available in Stata format, version 19.5.
...
> **Version of the data**: The data made available by BPLIM corresponds to a data freeze at a certain time of the year.[^3] Therefore, all files contain the information as reported in the extraction date. The most recent update of the data occurred in June 2026.
...
> **Digital Object Identifier**: 10.17900/CB.CBA.Jun2026.V1

> **New in this extraction**: Data for 2024 are now available, and the 2023 data have been revised. The variables *cae21*, *sitempresa*, and *datasitempresa* are no longer included in the General Information File (ROSTO).
...
Every year around the month of June, after the quality control process takes place, BPLIM creates a data freeze. The most recent version of the data was extracted on June 2026 and includes data from 2006 to 2024.
...
Where *A* stands for Anonymized and *yyyy*=2006,…,2024 and *eeee* reports the extraction date.
...
The file mainly contains information reported by firms through IES, together with variables computed by the Statistics Department of Banco de Portugal using data from complementary sources.
...
### A2. Declaration Characteristics
...
`Reporting Type` (*planocont*) – indicates the accounting system according to which the firm reports the information, i.e., *Plano Oficial de Contabilidade* (POC, Official Chart of Accounts) or *Sistema de Normalização Contabilística* (SNC, Accounting Standards System).
...
`Firm in liquidation` (*liquidacao*) - identifies firms in liquidation. According to the [Article 146 of the Portuguese Code of Commercial Companies](https://diariodarepublica.pt/dr/legislacao-consolidada/decreto-lei/1986-34443975), dissolved firms are required to add the expression "Em liquidação" to their name while they are in the liquidation process. This variable is created by BPLIM using the information contained in the company's name as reported by the firm in IES forms. It takes value one if the expression "em liquida" is found in the company's name.
...
`Indicator of Economic Activity` (*indactiecon*) – this variable reports the firm situation revised by the Statistics Department of *Banco de Portugal*. It is constructed using the information reported by the firm in IES and complemented with other sources. Notably, it takes into account whether the firm contracts new loans, maintains commercial transactions with firms abroad or pays and settles the Value Added Tax, among others.
...
`Legal form` (*natju*) – this variable reports firm’s legal form. For a complete list of codes see the metadata file [METATSC_CB_A_YFRM_20062024_JUN26_ROSTO_V01](./aux_files/metadata/METATSC_CB_A_YFRM_20062024_JUN26_ROSTO_V01.xlsx).

`Sector of Activity` (*cae3*, *caekotu*):

`Main Sector of Activity` (*cae3*) - reports firm's main sector of activity. The criteria to define the main sector of activity is the gross value added at factor cost. When it is not possible to use this information to define the main sector of activity, firms are requested to use turnover or the number of people permanently employed by the firm. From 2006 to 2008, firms classified their activity according to Revision 2.1 of the Portuguese Classification of Economic Activities at the highest level of disaggregation. Since 2008, firms report their main activity according to the “The Portuguese Classification of Economic Activities - Revision 3” (CAE Rev. 3). The Statistics Department of *Banco de Portugal* provides the information on the main sector of activity according to CAE Rev. 3 whenever possible. The source of this information is the CAE registered in the “Central Registry of Companies” for each company. Whenever the correspondence is not unique, the match between codes according to CAE Rev. 2.1 and CAE Rev. 3 is implemented based on the highest frequency of the matches.[^26] For a complete list of codes see the metadata file [METATSC_CB_A_YFRM_20062024_JUN26_ROSTO_V01](./aux_files/metadata/METATSC_CB_A_YFRM_20062024_JUN26_ROSTO_V01.xlsx).
...
`Municipality` (*concelho*) – provides information on the municipality in which the firm is located. The classification of this variable is according to *DICOFRE* and differs from the [Code of the administrative division](http://smi.ine.pt/Versao/Detalhes/17) for Autonomous Regions. For a complete list of codes see the metadata file [METATSC_CB_A_YFRM_20062024_JUN26_ROSTO_V01](./aux_files/metadata/METATSC_CB_A_YFRM_20062024_JUN26_ROSTO_V01.xlsx).
...
Table 2- Number of firms over the data period (as of June 2026 extraction)
...
- **Decree-Law no. 98/2015**, June 2 – introduces new size criteria for micro and small entities. A micro-entity must not exceed at least two of the following limits: i) total assets of 350,000 euros; ii) net turnover of 700,000 euros; or iii) an average of 10 employees. A small entity must not exceed at least two of the following limits: i) total assets of 4,000,000 euros; ii) net turnover of 8,000,000 euros; or iii) an average of 50 employees.

[Internal Link](./aux_files/legislation/Decreto-Lei_98_2015.pdf) /
  [External Link](https://diariodarepublica.pt/dr/detalhe/decreto-lei/98-2015-67356342)
...
| :--- | :---: | :---: | :---: |
| General Information | [meta_ROSTO](./aux_files/metadata/METATSC_CB_A_YFRM_20062024_JUN26_ROSTO_V01.xlsx) | - | [stat_ROSTO](./aux_files/descriptive_statistics/METATSS_CB_A_YFRM_20062024_JUN26_ROSTO_V01.xlsx) |
| Economic and Financial Information | [meta_CONTAS](./aux_files/metadata/METATSC_CB_A_YFRM_20062024_JUN26_CONTAS_V01.xlsx) | [var_CONTAS](./aux_files/variables_description/var_contas.html) | [stat_CONTAS](./aux_files/descriptive_statistics/METATSS_CB_A_YFRM_20062024_JUN26_CONTAS_V01.xlsx) |
| Employment Information | [meta_PESSOAL](./aux_files/metadata/METATSC_CB_A_YFRM_20062024_JUN26_PESSOAL_V01.xlsx) | [var_PESSOAL](./aux_files/variables_description/var_pessoal.html) | [stat_PESSOAL](./aux_files/descriptive_statistics/METATSS_CB_A_YFRM_20062024_JUN26_PESSOAL_V01.xlsx) |
| Trade Information per Market | [meta_MG](./aux_files/metadata/METATSC_CB_A_YFRM_20062024_JUN26_MG_V01.xlsx) | [var_MG](./aux_files/variables_description/var_mg.html) | [stat_MG](./aux_files/descriptive_statistics/METATSS_CB_A_YFRM_20062024_JUN26_MG_V01.xlsx) |
| Corporate Actions | [meta_AMARC](./aux_files/metadata/METATSC_CB_A_YFRM_20062024_JUN26_AMARC_V01.xlsx) | - | [stat_AMARC](./aux_files/descriptive_statistics/METATSS_CB_A_YFRM_20062024_JUN26_AMARC_V01.xlsx) |
| Economic and Financial Indicators | [meta_INDIC](./aux_files/metadata/METATSC_CB_A_YFRM_20062024_JUN26_INDIC_V01.xlsx) | [var_INDIC](./aux_files/variables_description/var_indic.html) | [stat_INDIC](./aux_files/descriptive_statistics/METATSS_CB_A_YFRM_20062024_JUN26_INDIC_V01.xlsx) |
| Cash Flows | [meta_CF](./aux_files/metadata/METATSC_CB_A_YFRM_20092024_JUN26_FLUXOSCAIXA_V01.xlsx) | [var_CF](./aux_files/variables_description/var_fluxoscaixa.html) | [stat_CF](./aux_files/descriptive_statistics/METATSS_CB_A_YFRM_20102024_JUN26_FLUXOSCAIXA_V01.xlsx) |
| Information by Sector of Activity | [meta_BYCAE](./aux_files/metadata/METATSC_CB_A_YFRM_20062024_JUN26_BYCAE_V01.xlsx) | [var_BYCAE](./aux_files/variables_description/var_bycae.html) | [stat_BYCAE](./aux_files/descriptive_statistics/METATSS_CB_A_YFRM_20062024_JUN26_BYCAE_V01.xlsx) |
...
Banco de Portugal Microdata Research Laboratory (BPLIM) (2026): Central Balance Sheet Annual Data. Extraction: June 2026. Version: V1. Banco de Portugal - BPLIM. Dataset. https://doi.org/10.17900/CB.CBA.Jun2026.V1
...
*| echo: true
*| code-fold: false
@dataset{CB.CBA.Jun2026.V1,
author = {{Banco de Portugal Microdata Research Laboratory (BPLIM)}},
publisher = {Banco de Portugal - BPLIM. Dataset},
title = {{C}entral {B}alance {S}heet {A}nnual {D}ata},
year = {2026},
version = {{ V1, Extraction: June 2026}},
doi = {10.17900/CB.CBA.Jun2026.V1},
url = {https://doi.org/10.17900/CB.CBA.Jun2026.V1}
}
```
